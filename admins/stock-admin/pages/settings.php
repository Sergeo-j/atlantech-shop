...
try {
    ...
    $stmt = $pdo->prepare("
        ...
        WHERE admin_id = ? AND module = 'stock'
    ");
    $stmt->execute([$_SESSION['admin_id']]);
            ...
            <div class="settings-section">
                ...
                <div class="info-card">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo htmlspecialchars($admin['role_name'] ?? 'Stock Admin'); ?></span>
                    </div>
                    <div class="info-row">
                    ...
                    <?php foreach ($recent_actions as $activity): ?>
                        <div class="activity-item">
                            <div class="activity-action">
                                <?php 
                                $action_labels = [
                                    'stock_movement_created' => 'Mouvement créé',
        ...
        <div class="card" style="margin-top: 20px;">
            ...
            <div style="padding: 20px;">
                <a href="dashboard.php" style="display: flex; align-items: center; gap: 10px; padding: 12px; background: rgba(255,255,255,0.02); border: 1px solid var(--border-color); border-radius: 8px; text-decoration: none; color: var(--text-primary); margin-bottom: 10px; transition: all 0.3s;">
                    <i class="fas fa-home" style="color: var(--neon-green);"></i>
                    <span>Dashboard</span>
                </a>
                
                <a href="inventory.php" style="display: flex; align-items: center; gap: 10px; padding: 12px; background: rgba(255,255,255,0.02); border: 1px solid var(--border-color); border-radius: 8px; text-decoration: none; color: var(--text-primary); margin-bottom: 10px; transition: all 0.3s;">
                    <i class="fas fa-boxes" style="color: var(--neon-cyan);"></i>
                    <span>Inventaire</span>
                </a>
                
                <a href="movements-list.php" style="display: flex; align-items: center; gap: 10px; padding: 12px; background: rgba(255,255,255,0.02); border: 1px solid var(--border-color); border-radius: 8px; text-decoration: none; color: var(--text-primary); transition: all 0.3s;">
                    <i class="fas fa-exchange-alt" style="color: var(--neon-gold);"></i>
