...
if (!defined('CSRF_TOKEN_LIFETIME')) define('CSRF_TOKEN_LIFETIME', 1800); // 30 minutes

// Chemins
if (!defined('BASE_URL'))   define('BASE_URL', env('SITE_URL', 'http://localhost/atlantech-shop') . '/admins/client-admin/');
if (!defined('ADMIN_PATH')) define('ADMIN_PATH', __DIR__);
...
try {
    ...
    error_log('PDO connect error (client-admin): ' . $e->getMessage());
