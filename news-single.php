...
<head>
    ...
    <title>AtlanTech — Votre Tech, Livrée</title>
                ...
                <div class="container">
                    <div class="header__top-info ul_li_between mt-none-10">
                        <ul class="ul_li mt-10">
                            ...
                            <li><i class="fas fa-heart"></i>Bienvenue chez AtlanTech — Votre spécialiste High-Tech en Haïti</li>
                        </ul>
                ...
                <div class="header__middle ul_li_between justify-content-xs-center">
                    ...
                    <div class="header__lang ul_li">
                        ...
                        <div class="header__language">
                            <ul>
                                <li><a href="#!" class="lang-btn"><img loading="lazy" src="assets/img/icon/ht_flag.svg" style="width:22px;height:15px;object-fit:cover;border-radius:2px;vertical-align:middle;margin-right:5px;" alt="">English <i class="far fa-chevron-down"></i></a>
                                    <ul class="lang_sub_list">
                    ...
                    <div class="header__icons ul_li">
                        <div class="icon">
                            <a href="#!"><img loading="lazy" src="assets/img/icon/user.svg" alt=""></a>
                        </div>
                            ...
                            <div class="blog-post-wrap mt-50">
                                <article class="post-details">
                                    <figure class="post-thumb mb-30">
                                        <img loading="lazy" src="assets/img/news/img_15.jpg" alt="">
                                    </figure>
                                    ...
                                    <ul class="post-meta meta-bottom-border ul_li mt-25">
                                        <li>
                                            <div class="post-meta__author ul_li">
                                                <div class="avatar">
                                                    <img loading="lazy" src="assets/img/avatar/img_02.jpg" alt="">
                                                </div>
                                    ...
                                    <blockquote class="mt-40">
                                        ...
                                        <img loading="lazy" class="quote" src="assets/img/icon/quote.html" alt="">
                                    </blockquote>
                                    <div class="row mb-35 mt-20"> 
                                        <div class="col-lg-5 mt-30">
                                            <div class="post-thumb pos-rel">
                                                <img loading="lazy" src="assets/img/news/img_16.jpg" alt="">
                                                <a href="https://www.youtube.com/watch?v=cRXm1p-CNyk" class="popup-video"><i class="fas fa-play"></i></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-7 mt-30">
                                            <div class="post-thumb">
                                                <img loading="lazy" src="assets/img/news/img_17.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-10">
                                        <div class="col-xl-7 col-lg-12 mt-25">
                                            <div class="post-img pos-rel">
                                                <img loading="lazy" src="assets/img/news/img_18.jpg" alt="">
                                    ...
                                    <div class="video mt-55 mb-30">
                                        <div class="video-thumb pos-rel">
                                            <img loading="lazy" src="assets/img/news/img_19.jpg" alt="">
                                            <a href="https://www.youtube.com/watch?v=cRXm1p-CNyk" class="popup-video"><i class="fas fa-play"></i></a>
                                        </div>
                                    ...
                                    <div class="row post-nav">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="post-nav__wrap left-post">
                                                ...
                                                <div class="post-nav__item tx-post ul_li">
                                                    <div class="post-thumb">
                                                        <a href="news-single.html"><img loading="lazy" src="assets/img/news/img_20.jpg" alt=""></a>
                                                    </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="post-nav__wrap right-post">
                                                ...
                                                <div class="post-nav__item tx-post ul_li">
                                                    <div class="post-thumb">
                                                        <a href="news-single.html"><img loading="lazy" src="assets/img/news/img_21.jpg" alt=""></a>
                                                    </div>
                                                    <div class="post-content">
                                                ...
                                                <div class="latest__comments">
                                                    <ul class="list-unstyled mb-0">
                                                        <li>
                                                            <div class="comments-box">
                                                                <div class="comments-avatar">
                                                                    <img loading="lazy" src="assets/img/avatar/comments/img_01.jpg" alt="">
                                                                </div>
                                                        ...
                                                        <li class="children">
                                                            <div class="comments-box">
                                                                <div class="comments-avatar">
                                                                    <img loading="lazy" src="assets/img/avatar/comments/img_02.jpg" alt="">
                                                                </div>
                                                                <div class="comments-text">
                                                                    <div class="avatar-name">
                                                        ...
                                                        <li>
                                                            <div class="comments-box">
                                                                <div class="comments-avatar">
                                                                    <img loading="lazy" src="assets/img/avatar/comments/img_03.jpg" alt="">
                                                                </div>
                                                                <div class="comments-text">
                                                                    <div class="avatar-name">
                                        ...
                                        <div class="widget__post-slide tx-arrow">
                                            <div class="post-item">
                                                <div class="ul_li tx-post">
                                                    <div class="post-thumb">
                                                        <a href="news-single.html"><img loading="lazy" src="assets/img/news/img_11.jpg" alt=""></a>
                                                ...
                                                <div class="ul_li tx-post">
                                                    <div class="post-thumb">
                                                        <a href="news-single.html"><img loading="lazy" src="assets/img/news/img_12.jpg" alt=""></a>
                                                ...
                                                <div class="ul_li tx-post">
                                                    <div class="post-thumb">
                                                        <a href="news-single.html"><img loading="lazy" src="assets/img/news/img_13.jpg" alt=""></a>
                                                ...
                                                <div class="ul_li tx-post">
                                                    <div class="post-thumb">
                                                        <a href="news-single.html"><img loading="lazy" src="assets/img/news/img_14.jpg" alt=""></a>
            ...
            <div class="container">
                ...
                <div class="footer__bottom ul_li_center">
                    <div class="footer__copyright mt-15">
                        &copy; <?= date('Y') ?> <a href="index.php">AtlanTech</a>. Tous droits réservés.
                    </div>
                    ...
                    <div class="payment_method mt-15">
                        <img loading="lazy" src="assets/img/bg/payment_method.png" alt="">
                    </div>
                </div>
            </div>
        </footer>
